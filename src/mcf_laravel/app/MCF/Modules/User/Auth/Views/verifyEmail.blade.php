...
{{-- --}}
{{-- --------------------------------------------------------------------- --}}
{{-- MCF Authentication - Verify Email --}}
{{-- --------------------------------------------------------------------- --}}
{{-- --}}
{{-- This page verifies the authenticated email address using the --}}
{{-- verification code sent to the user's email address. --}}
{{-- --}}
{{-- The email address is passed through the route. --}}
...
<div class="mcf-profile-form-card">
    ...
    <div class="mcf-profile-form-resend">
        ...
        ['email' => $email],
            ...
            <p id="mcf-resend-status" class="mcf-profile-form-resend-status">
